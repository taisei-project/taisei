...
void good_ending_marisa(Ending *e) {
	...
	add_ending_entry(e, -1, "“Right,” Marisa agreed, strangely thoughtful compared to her brash front, “but there is really somethin’ more to this place, isn’t there? I can’t stop now! I’ll be the one to find the truth for ya!”", NULL);
	...
	add_ending_entry(e, -1, "“Did’ja forget? Gensōkyō takes pretty much anyone. I’m sure there are a few of us that’ll be pretty excited to see you and Kurumi again. And who knows; the Human Village could always use a cool new professor in town, right? There’s no reason to throw away everything you’ve learned!”", NULL);
