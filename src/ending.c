...
void good_ending_marisa(Ending *e) {
	...
	add_ending_entry(e, -1, "“Imagine if I had actually unraveled Gensōkyō’s truth…!” she finally said, shaking her head. “It may be for the best. Even Gensōkyō has its own form of common sense, and once that is gone, there is no telling what have could be lost.”", NULL);
