...
Dialog *stage6_dialog(void) {
	...
	if(pc->id == PLR_CHAR_MARISA) {
		...
		dadd_msg(d,Right, "After Yuuka was defeated and left us for Gensōkyō, Kurumi and I decided we needed to do some soul searching and find another job.");
		...
		dadd_msg(d,Right, "This world I’ve built… this is a world dictated not by the madness of Gensōkyō, but of reason, logic, and common sense!");
		...
		dadd_msg(d,Right, "That is because you completely misunderstand. I am not a shikigami, and never was. My duty was once to protect a powerful youkai, but when she left for Gensōkyō, I was left behind.");
