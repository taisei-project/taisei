...
static void stage1_draw(void) {
	set_perspective(&stage_3d_context, 500, 10000);
...
static void stage1_start(void) {
	init_stage3d(&stage_3d_context, 32);
	add_model(&stage_3d_context, stage1_water_draw, stage1_bg_pos);
	add_model(&stage_3d_context, stage1_waterplants_draw, stage1_waterplants_pos);
	add_model(&stage_3d_context, stage1_snow_draw, stage1_snow_pos);
