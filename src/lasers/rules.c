...
static cmplx laser_rule_chain_impl(Laser *l, real t, void *ruledata) {
	if(t == EVENT_BIRTH) {
		return 0;
	}
...
IMPL_LASER_RULE_DATAGETTER(laser_get_ruledata_chain,
	laser_rule_chain_impl, LaserRuleChainData)
