...
.phases = (CutscenePhase[]) {
	{ "cutscenes/locations/moriya", {
		...
		T_NARRATOR("A workaholic shrine at the top of Youkai Mountain."),
		{ 0 },
	}},
	{ "cutscenes/locations/moriya", {
	...
	{ "cutscenes/reimu_extra/02", {
		...
		T_YUKARI("You do care very deeply about Gensokyo, and everyone within it, don't you?"),
		{ 0 },
	}},
	{ "cutscenes/reimu_extra/02", {
		T_YUKARI("Even those who fundamenally threaten us. You even give the nastiest youkai a chance at redemption."),
