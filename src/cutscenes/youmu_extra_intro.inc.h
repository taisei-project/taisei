...
.name = N_("Yōmu (Extra Stage Intro)"),
.bgm = "intro",

.phases = (CutscenePhase[]) {
	{ "cutscenes/locations/netherworld", {
		T_NARRATOR("— The Netherworld"),
		T_NARRATOR("The nexus between life and death."),
		{},
	}},
	{ "cutscenes/locations/netherworld", {
	...
	{ "cutscenes/youmu_extra/01", {
		T_YOUMU("Hm? Is something the matter, my dear?"),
		T_ELLY("The Tower…! No, it can’t be! But I…!"),
		T_YOUMU("Has something changed?"),
		T_ELLY("It’s turning back on! In fact, at its current rate of power, it could—"),
		{},
	}},
	{ "cutscenes/youmu_extra/01", {
		T_ELLY("… there’s no other explanation for this."),
		T_ELLY("It’s her… the one I told you about."),
	...
	{ "cutscenes/youmu_extra/02", {
		...
		T_ELLY("Please forgive me, Yōmu!"),
		{},
	}},
	{ "cutscenes/youmu_extra/02", {
		T_YOUMU("I completely understand."),
		T_ELLY("You… do?"),
		T_YOUMU("Yes, of course. There’s a time and place to face one’s fears. This is not your time or place, even somewhat literally."),
		T_YOUMU("However, don’t think you've gotten off so easily. When I return, it shall be your turn to pay for dinner. Understand?"),
		{},
	}},
	{ "cutscenes/youmu_extra/02", {
