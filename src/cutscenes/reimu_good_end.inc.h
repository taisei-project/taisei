...
.phases = (CutscenePhase[]) {
	...
	{ "cutscenes/reimu_good/03", {
		...
		T_NARRATOR("Even as some grew to accept the Tower of Babel looming in the skyline, there were frequent mutterings over potentially getting rid of it entirely."),
