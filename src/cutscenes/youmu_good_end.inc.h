...
.phases = (CutscenePhase[]) {
	{ "cutscenes/locations/moriya", {
		...
		T_NARRATOR("A dignified shrine at the top of Youkai Mountain."),
		{ 0 },
	}},
	{ "cutscenes/locations/moriya", {
	...
	{ "cutscenes/locations/moriya", {
		...
		T_NARRATOR("Although, oddly, Youmu retained much of the confidence she had gained in the incident, despite the Tower's presence no longer having any effect..."),
		{ 0 },
	}},
	{ "cutscenes/youmu_good/02", {
		T_ELLY("This Gensokyo is so different compared to the one I was used to."),
		T_YOUMU("What was your Gensokyo like, if I may ask?"),
	...
	{ "cutscenes/youmu_good/02", {
		...
		T_NARRATOR("As they spent many evenings dueling, practicing, and drinking merrily, many folks commented on how they had never seen Youmu so thrilled."),
		{ 0 },
	}},
	{ "cutscenes/youmu_good/02", {
		T_NARRATOR("As The Tower of Babel continued to impose its menacing presence on the skyline of Gensokyo, nobody had figured out how to remove it."),
		...
		T_NARRATOR("Meanwhile, in the underworld, a certain violet-tinged youkai and her ethereal lady companion discussed the intimiate detail of an ancient future's past..."),
		{ 0 },
	}},
	{ "cutscenes/youmu_good/02", {
