...
.phases = (CutscenePhase[]) {
	...
	{ "cutscenes/locations/moriya", {
		...
		T_NARRATOR("… which had become filthy from the local kappa partying non-stop…"),
        T_NARRATOR("… and some so-called ‘political demonstrations’ by the newly-formed ‘Insect Party’."),
		{ 0 },
	}},
	{ "cutscenes/locations/moriya", {
		...
		T_ELLY("Ah, I see. Facinating. Incredible."),
	...
	{ "cutscenes/locations/moriya", {
        ...
        T_NARRATOR("\nElly, despite her politeness, struggled to hold back tears of boredom."),
		{ 0 },
	}},
	{ "cutscenes/locations/moriya", {
		T_NARRATOR("In the end, the newcomers seemed to settle down once the effects of the Tower had worn off, like everyone else in Gensōkyō.\n"),
	...
	{ "cutscenes/marisa_good/02", {
		...
		T_MARISA("I mean, ‘course ya lost. Mathematics has always had a soft spot for magic. Don’t ya know about that one guy, Isaac Newton?"),
		T_ELLY("The famous European mathematician? I studied his works, yes, while I lived in the Tower. Very foundational. But what about him?"),
	...
	{ "cutscenes/marisa_good/02", {
		...
		T_ELLY("Hah. I never ran across any of *those* books of his…"),
		{ 0 },
	}},
	{ "cutscenes/marisa_good/02", {
		...
		T_MARISA("What’s the point in worryin’ about all that?"),
	...
	{ "cutscenes/marisa_good/02", {
		T_MARISA("Yeah! A while ago, I was cookin’ up some especially powerful ones I found in a cave on this very mountain…"),
		T_MARISA("And then, BOOM, there was an explosion!"),
	...
	{ "cutscenes/marisa_good/02", {
		T_ELLY("That’s ridiculous."),
		T_ELLY("But I suppose in a place like Gensōkyō, it’s not even that strange…"),
		T_ELLY("The version I knew of you was just a child, too."),
