...
typedef struct RendererFuncs {
	...
	bool (*texture_type_query)(TextureType type, TextureFlags flags, PixmapFormat pxfmt, TextureTypeQueryResult *result);
	...
	uint (*index_buffer_get_index_size)(IndexBuffer *ibuf);
