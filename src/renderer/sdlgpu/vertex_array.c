...
static SDL_GpuVertexElementFormat vertex_elem_format(VertexAttribType type, VertexAttribConversion conv, uint vsize) {
	static struct {
		...
		[SDL_GPU_VERTEXELEMENTFORMAT_VECTOR2]          = { 2, VA_FLOAT, VA_CONVERT_FLOAT },
		[SDL_GPU_VERTEXELEMENTFORMAT_VECTOR3]          = { 3, VA_FLOAT, VA_CONVERT_FLOAT },
		[SDL_GPU_VERTEXELEMENTFORMAT_VECTOR4]          = { 4, VA_FLOAT, VA_CONVERT_FLOAT },
		[SDL_GPU_VERTEXELEMENTFORMAT_COLOR]            = { 4, VA_UBYTE, VA_CONVERT_FLOAT },
		[SDL_GPU_VERTEXELEMENTFORMAT_BYTE4]            = { 4, VA_BYTE, VA_CONVERT_FLOAT_NORMALIZED },
		[SDL_GPU_VERTEXELEMENTFORMAT_SHORT2]           = { 2, VA_SHORT, VA_CONVERT_INT },
		[SDL_GPU_VERTEXELEMENTFORMAT_SHORT4]           = { 4, VA_SHORT, VA_CONVERT_INT },
		[SDL_GPU_VERTEXELEMENTFORMAT_NORMALIZEDSHORT2] = { 2, VA_SHORT, VA_CONVERT_FLOAT_NORMALIZED },
		[SDL_GPU_VERTEXELEMENTFORMAT_NORMALIZEDSHORT4] = { 4, VA_SHORT, VA_CONVERT_FLOAT_NORMALIZED },

		// Not supported by our API yet
		// [SDL_GPU_VERTEXELEMENTFORMAT_HALFVECTOR2]      = { 0 },
		// [SDL_GPU_VERTEXELEMENTFORMAT_HALFVECTOR4]      = { 0 },
	};
...
void sdlgpu_vertex_array_layout(VertexArray *varr, uint nattribs, VertexAttribFormat attribs[nattribs]) {
	...
	for(uint i = 0; i < nattribs; ++i) {
		auto want_binding = (SDL_GpuVertexBinding) {
			...
			.inputRate = attribs[i].spec.divisor,
