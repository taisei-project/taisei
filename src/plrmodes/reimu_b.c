...
PlayerMode plrmode_reimu_b = {
	.name = "Dream Shaper",
	.description = "Utilize techniques you borrowed from an eldritch ’friend,’ and tie the boundaries of spacetime into knots as easily as the ribbons in your hair.",
