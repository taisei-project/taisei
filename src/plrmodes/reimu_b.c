...
PlayerMode plrmode_reimu_b = {
	.name = "Dream Shaper",
	.description = "Utilize Non-Euclidean geometry you borrowed from a ’friend,’ and tie the boundaries of space-time into knots as easily as the ribbons in your hair.",
