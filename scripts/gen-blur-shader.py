...
def sampler_func_name(args):
    return f'{args.name.upper()}_SAMPLER_FUNC'
...
def gen_shader_func(args):
    ...
    sampler_func = sampler_func_name(args)
    ...
    for i in range(-kernel_half_size, kernel_half_size+1):
        ...
        s += f'{prefix}{sampler_func}(tex, uv{uv_ofs}) * {kernel[kernel_half_size + i]}{term}\n'
...
def main(args):
    ...
    shaders = args.rootdir / 'resources' / '00-taisei.pkgdir' / 'shader'
